        ...
        match key.code {
            ...
            KeyCode::Char('t') => {
                ...
                if let Some(task) = self.task_list.get_selected_task() {
                    self.logger.log(format!("Global key: 't' - setting task '{}' due today", task.content));
            ...
            KeyCode::Char('T') => {
                ...
                if let Some(task) = self.task_list.get_selected_task() {
                    self.logger.log(format!("Global key: 'T' - setting task '{}' due tomorrow", task.content));
            ...
            KeyCode::Char('w') => {
                ...
                if let Some(task) = self.task_list.get_selected_task() {
                    self.logger.log(format!("Global key: 'w' - setting task '{}' due next week", task.content));
            ...
            KeyCode::Char('W') => {
                ...
                if let Some(task) = self.task_list.get_selected_task() {
                    self.logger.log(format!("Global key: 'W' - setting task '{}' due weekend", task.content));
